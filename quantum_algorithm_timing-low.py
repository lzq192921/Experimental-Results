...
def evaluate_performance(k_values, n_values, shots=1024, noise=True):
    ...
    if noise:
        ...
        p1 = 0.0001  # Single-qubit gate error rate
        p2 = 0.001   # CNOT gate error rate
...
def main():
    ...
    results, total_time = evaluate_performance(k_values, n_values, shots, noise=True)
